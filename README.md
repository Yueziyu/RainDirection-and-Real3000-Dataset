...
# Data overview
We have maked available a new rainy dataset **RainDirection** with the direction information of rain streak and a new real world rainy dataset **Real3000**. You can download **RainDirection** and **Real3000** dataset from this [BaiduYun link](https://pan.baidu.com/s/1x4TuEDfTDCiZgqIKqXWnQg) (Extract code: 0113).
## RainDirection
